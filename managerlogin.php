...
<html>
  ...
  <body>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top navigation-clean-search" role="navigation">
     ...
     <center><h1>Hi Manager,<br> Welcome to FOODWALA </h1></center>
     <br>
   <center><p>Kindly LOGIN to continue.</p></center>
    </div>
    </div>
      ...
      <div class="col-md-5 col-md-offset-4">
        ...
        <div class="row">
          <div class="form-group col-xs-4">
              <button class="button" name="submit" type="submit" value=" Login ">Submit</button>
