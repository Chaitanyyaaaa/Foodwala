...
?>
    ...
    <br>
     ...
     <center><strong>Want to contact FOODWALA ?</strong></center>
     <br>
    <center>Here are a few ways to get in touch with us.</center>
    </div>
    ...
    <div class="col-md-5" style="float: none; margin: 0 auto;">
        ...
        <form method="post" >
          ...
          <div class="form-group">
           <textarea class="form-control" type="textarea" id="message" name="message" placeholder="Message" maxlength="140" rows="3"></textarea>
