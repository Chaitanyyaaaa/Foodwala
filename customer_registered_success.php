...
?>
		...
		<CENTER><h2> <?php echo "Welcome $fullname!" ?> </h2></CENTER>
		<CENTER><h1>Your account has been created.</h1></CENTER>
		<CENTER<p>Login Now from <a href="customerlogin.php">HERE</a></p></CENTER>
	</div>
</div>
